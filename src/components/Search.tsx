        ...
        <div className="flex items-center">
            ...
            <div className="flex items-center h-10">
                <div className="flex items-center h-full w-full relative ml-8">
                    ...
                    <button className="hover:px-8 transition-all absolute right-0 bg-indigo-700 h-full w-10 rounded-full flex items-center justify-center text-white"><BiSearchAlt className="fixed"/></button>
                </div>
            </div>
        </div>
    )
